...
const HOCFooterUpdateFetchWerbeTarife = React.lazy(() => import('components/footer/HOC-footer-update-fetch-werbetarife'));
var CancelToken;
var source;
class UpdateMediaTarifeFormComponent extends React.Component {
    constructor(props) {
        super(props);
    ...
    updateYourMediaTarife = (event) => {
        event.preventDefault();
        this.updateMediaTarrife();
    }
    handleValue = (event) => {
    ...
    render() {
        ...
        if (isLoaded) {
            return (
                <div>
                    <Suspense fallback={<div>Loading...</div>}>
                        ...
                        <HOCFooterUpdateFetchWerbeTarife data={data} />
                    </Suspense>
                </div>
            );
            ...
            return (<Form>{arrayOfkeyOfState.map((data, index) => {
                ...
                <Button onClick={this.updateYourMediaTarife}>{'Update your AGBs'}</Button>
            </Form>
            );
        }
    }
}
export default UpdateMediaTarifeFormComponent;