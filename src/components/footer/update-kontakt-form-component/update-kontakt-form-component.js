...
const HOCFooterUpdateFetchKontakt = React.lazy(() => import('components/footer/HOC-footer-update-fetch-kontakt'));
var CancelToken;
var source;
class UpdateKontaktFormComponent extends React.Component {
    constructor(props) {
        super(props);
            ...
            return (
                <div>
                    <Suspense fallback={<div>Loading...</div>}>
                        ...
                        <HOCFooterUpdateFetchKontakt data={data} />
                    </Suspense>
                </div>
            );
...
export default UpdateKontaktFormComponent;