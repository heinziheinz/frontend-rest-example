...
const FormImpressum = (props) => {
    ...
    const onAddingAgbText = (event) => {
        ...
        setState({
            ...state,
            impressumTexarea: event.target.value,
            onAddingText: true
        });
    }
    ...
    if (state.onAddingText && state.onAddingHeadline && state.submit) {
        ...
        return (
            <Form>
                ...
                <FormGroup>
                    <Label for="impressumTexarea">Text Area</Label>
                    <Input type="textarea" name="impressumTexarea" id="impressumTexarea" onChange={onAddingAgbText} />
                </FormGroup>
                <ErrorDisplay error={errors['impressumTexarea']} />
                <Button name="submit" onClick={fileSubmit}>Submit</Button>
            </Form>
        );
    }
};
export default FormImpressum;
/**
