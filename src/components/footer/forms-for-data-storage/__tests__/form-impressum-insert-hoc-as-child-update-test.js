...
import FormImpressuminsertHOCasChildUpdate from 'components/footer/forms-for-data-storage/form-impressum-insert-hoc-as-child-update';
...
describe('<FormImpressuminsertHOCasChildUpdate/>', () => {
    test("Form can be submited & input field is modifiable and redirect to form works", async () => {
        ...
        const { debug, queryByTestId, getByText, getByRole, container } = render(
            <Router history={history}>
                <FormImpressuminsertHOCasChildUpdate />
