...
import FormDatenschutzInsertHOCasChildUpdate from 'components/footer/forms-for-data-storage/form-datenschutz-insert-hoc-as-child-update';
...
describe('<FormDatenschutzInsertHOCasChildUpdate/>', () => {
    test("Form can be submited & input field is modifiable and redirect to form works", async () => {
        ...
        const { debug, queryByTestId, getByText, getByRole, container } = render(
            <Router history={history}>
                <FormDatenschutzInsertHOCasChildUpdate />
