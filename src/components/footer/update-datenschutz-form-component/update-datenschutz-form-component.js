...
const HOCFooterUpdateFetchDatenschutz = React.lazy(() => import('components/footer/HOC-footer-update-fetch-datenschutz'));
var CancelToken;
var source;
class UpdateDatenschutzFormComponent extends React.Component {
    constructor(props) {
        super(props);
            ...
            return (
                <div>
                    <Suspense fallback={<div>Loading...</div>}>
                        ...
                        <HOCFooterUpdateFetchDatenschutz data={data} />
                    </Suspense>
                </div>
            );
...
export default UpdateDatenschutzFormComponent;