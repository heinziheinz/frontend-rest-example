...
import Impressum from 'components/footer/impressum-update-confirmation-component';
...
export default class HOCFusion extends React.Component {
    ...
    constructor(props) {
        ...
        this.Wrapper = {
            fetch: WithFetchFooterComponent(WithLocalStorage(Impressum, null), process.env.REACT_APP_URL + 'api/impress/impress/{impress}', option, null, path)
        };
    }
    render() {
        return (
